...
HD_PWD='C:/Users/VLSI/Desktop/movement/movement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log movement.vds -m64 -mode batch -messageDb vivado.pb -notrace -source movement.tcl
