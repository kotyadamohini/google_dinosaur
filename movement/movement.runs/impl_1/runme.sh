...
HD_PWD='C:/Users/VLSI/Desktop/movement/movement.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log movement.vdi -applog -m64 -messageDb vivado.pb -mode batch -source movement.tcl -notrace
