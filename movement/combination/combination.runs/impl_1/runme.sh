...
HD_PWD='C:/Users/vlsilab/Desktop/combination/combination.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combination.vdi -applog -m64 -messageDb vivado.pb -mode batch -source combination.tcl -notrace
