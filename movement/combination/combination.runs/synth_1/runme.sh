...
HD_PWD='C:/Users/vlsilab/Desktop/combination/combination.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combination.vds -m64 -mode batch -messageDb vivado.pb -notrace -source combination.tcl
